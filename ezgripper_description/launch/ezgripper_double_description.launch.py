#!/usr/bin/env python3
"""
Spawn Double EZGripper - Description Component
"""
...
def generate_launch_description():
    ...
    urdf_file = os.path.join(pkg_dir, 'urdf', 'ezgripper_double_with_mount_standalone.urdf.xacro')
    
    # Declare launch arguments 3
    ...
    joint_publisher_include = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'prefix': LaunchConfiguration('prefix')  # Pass the prefix to the joint publisher
        }.items(),
    ...
    shutdown_handler = RegisterEventHandler(
        OnShutdown(
            on_shutdown=[
                LogInfo(msg=['Shutting down EZGripper Double description']),
    ...
    return LaunchDescription([
        ...
        rviz_arg,
        # Using position-based numbering for double gripper
        prefix_arg,
